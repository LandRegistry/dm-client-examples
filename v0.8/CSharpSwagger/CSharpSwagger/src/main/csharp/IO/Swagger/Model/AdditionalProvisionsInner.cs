...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalProvisionsInner :  IEquatable<AdditionalProvisionsInner>, IValidatableObject
    {
        /// <summary>
        ...
        public AdditionalProvisionsInner(string AdditionalProvisionCode = default(string), string Description = default(string))
        {
