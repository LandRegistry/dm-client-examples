...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChargeClause :  IEquatable<ChargeClause>, IValidatableObject
    {
        /// <summary>
        ...
        public ChargeClause(string CreCode = default(string), string Description = default(string))
        {
