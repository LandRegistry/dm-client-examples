...
namespace IO.Swagger.Model
{
    ...
    public partial class DeedApplication :  IEquatable<DeedApplication>, IValidatableObject
    {
        ...
        public DeedApplication(string TitleNumber = default(string), Borrowers Borrowers = default(Borrowers), string MdRef = default(string), string IdentityChecked = default(string), string PropertyAddress = default(string), string Reference = default(string), string DateOfMortgageOffer = default(string), string DeedEffector = default(string))
        {
            ...
            this.DeedEffector = DeedEffector;
        }
        ...
        /// <summary>
        /// Name of the legal deed effector. To be used where the legal deed effector name is different to that of the conveyancer.
        /// </summary>
        /// <value>Name of the legal deed effector. To be used where the legal deed effector name is different to that of the conveyancer.</value>
        [DataMember(Name="deed_effector", EmitDefaultValue=false)]
        public string DeedEffector { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeedEffector: ").Append(DeedEffector).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(DeedApplication other)
        {
            ...
            return 
                ...
                (
                    this.DeedEffector == other.DeedEffector ||
                    this.DeedEffector != null &&
                    this.DeedEffector.Equals(other.DeedEffector)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeedEffector != null)
                    hash = hash * 59 + this.DeedEffector.GetHashCode();
                return hash;
            }
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TitleNumber, must match a pattern of " + regexTitleNumber, new [] { "TitleNumber" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MdRef, must match a pattern of " + regexMdRef, new [] { "MdRef" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IdentityChecked, must match a pattern of " + regexIdentityChecked, new [] { "IdentityChecked" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PropertyAddress, must match a pattern of " + regexPropertyAddress, new [] { "PropertyAddress" });
            }
