    ...
    public partial class MakeEffectiveApi : IMakeEffectiveApi
    {
        ...
        public ApiResponse< OperativeDeed > DeedDeedReferenceMakeEffectivePostWithHttpInfo (string deedReference)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling DeedDeedReferenceMakeEffectivePost: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling DeedDeedReferenceMakeEffectivePost: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
